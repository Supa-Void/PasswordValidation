...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check("pw len = 20", PasswordValidator.validate("aA345678Asgsgggrhehwgds") == false);
        check("pw len > 20", PasswordValidator.validate("aA34567854434hhdjfgfgds") == false);
        ...
        check("pw no lower", PasswordValidator.validate("AAA345678") == false);
        // TODO: R5 - ไม่มีตัวเลข -> false
        check("pw no num ", PasswordValidator.validate("aAghds") == false);
        // TODO: R6 - มีช่องว่าง -> false
        check("pw have space ", PasswordValidator.validate("f gfgjg ") == false);

        // TODO: boundary อื่นๆ ที่คุณคิดว่าจำเป็น
        check("pw have ! ", PasswordValidator.validate("fgfgjggh ") == false);
        check("pw have @ ", PasswordValidator.validate("fgfgjgrg ") == false);
        check("pw have _ ", PasswordValidator.validate("fgfgjgrg ") == false);
